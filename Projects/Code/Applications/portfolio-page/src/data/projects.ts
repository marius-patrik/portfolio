...
export const projects: Project[] = [
  ...
  // Hardware Projects
  {
    ...
    description: "Linear actuator hardware project for precise linear motion control.",
  ...
  },
  {
    id: "robot-arm",
    name: "Robot Arm",
    description: "Robotic arm project with multi-axis control and precision movement.",
    techStack: ["Hardware", "Robotics", "Electronics", "Mechanical Engineering"],
    category: "hardware",
  ...
  },
  {
    ...
    description: "Rotary actuator hardware project for rotational motion control.",
    techStack: ["Hardware", "Electronics", "Mechanical Engineering"],
    category: "hardware",
  ...
  },
  {
    ...
    description: "Advanced humanoid robot project with advanced control systems.",
    techStack: [
      "Hardware",
      "Robotics",
      "AI",
  ...
  },
  {
    id: "vr-headset",
    name: "VR Headset",
    description: "Virtual reality headset hardware project with immersive display technology.",
    techStack: [
      "Hardware",
      "VR",
      "Electronics",
