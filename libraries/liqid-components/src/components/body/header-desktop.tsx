...
const HeaderDesktop: react.FC<{
	...
	return (
		<div className="invisible md:h-auto md:visible p-2 gap-2 flex flex-row justify-items-start items-center fixed z-50 w-full">
			<Link
				onClick={handleback}
				href={''}
				className="flex p-3 style-title w-full md:w-auto style-glass"
				id="back button"
			>
				<svg
			...
			<div className="ml-auto invisible md:visible flex flex-row gap-2 px-4 style-glass rounded-full">
				<FooterButton
					href="/history"
